...
import com.zww.bean.*;
import com.zww.service.*;
import com.zww.utils.AliYunOssUtil;
...
//				AliYunOssUtil.upload(newFileName.getBytes(),fileName);
//				AliYunOssUtil.upload(file.getBytes(),newFileName);
