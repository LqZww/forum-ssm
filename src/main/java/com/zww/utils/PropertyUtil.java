...
public class PropertyUtil {
	...
	/**
	 * 获取配置文件tokenconfig.properties的信息
	 * @return
	 */
	...
	/**
	 * 获取配置文件pageconfig.properties的信息
	 * @return
	 */
	public static Properties getPropertiesPage() {
		...
		try {
			// 获取属性文件中的内容（将属性文件中的内容读取到一个输入流中）
			InputStream in = PropertyUtil.class.getClassLoader().getResourceAsStream("pageconfig.properties");
